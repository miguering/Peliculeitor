...
public class PeliculasFavoritasAdapter extends RecyclerView.Adapter<PeliculasFavoritasAdapter.PeliculasFavoritasAdapterViewHolder>{

    /*Arraylist donde almaceno los datos que se van a mostrar en el RecylerView*/
    private List<DetallePelicula> datos;

    private final PeliculasFavoritasAdapter.OnItemClickListener listener;

    public void swap(List<DetallePelicula> datos1) {
        datos = datos1;
    }

    public void add(DetallePelicula p){
        datos.add(p);
    ...
    public interface OnItemClickListener {
        void onItemClick(DetallePelicula item);
    }

    /* Incluyo el Viewholder en el Adapter */
    public static class PeliculasFavoritasAdapterViewHolder
        ...
        public PeliculasFavoritasAdapterViewHolder(View itemView) {
            super(itemView);
        ...
        public void bindPeliculas(DetallePelicula j, final PeliculasFavoritasAdapter.OnItemClickListener listener) {
    ...
    public PeliculasFavoritasAdapter(List<DetallePelicula> datos, PeliculasFavoritasAdapter.OnItemClickListener listener) {
        this.datos = datos;
        this.listener = listener;
    }

    @Override
    public PeliculasFavoritasAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        PeliculasFavoritasAdapterViewHolder listapeliculasVH = new PeliculasFavoritasAdapterViewHolder(itemView);
        /* devuelve la vissta*/
        return listapeliculasVH;
    }

    @Override
    public void onBindViewHolder(PeliculasFavoritasAdapterViewHolder viewHolder, int pos) {
        DetallePelicula j = datos.get(pos);
